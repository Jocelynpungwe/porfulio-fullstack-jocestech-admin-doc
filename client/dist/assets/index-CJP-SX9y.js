...
`,vb=()=>{const{isLoading:e,user:t}=H(f=>f.user),{orderLoading:r,orderError:n}=H(f=>f.order),i=me(),s=Qn(),o={name:(t==null?void 0:t.name)||"",email:(t==null?void 0:t.email)||"",isResetPassword:!1,oldPassword:"",newPassword:""},[a,l]=b.useState(o);b.useEffect(()=>{if(!t){s("/"),l(o);return}i(wa())},[t]);const c=f=>{f.preventDefault();const{name:p,email:x,isResetPassword:g,oldPassword:v,newPassword:S}=a;if((!p||!x)&&!g){I.error("Please Fill Out All Fields");return}if(g&&(!v||!S)){I.error("Please All Password Fields ");return}if(g){i(Pa({oldPassword:v,newPassword:S}));return}i(ba({name:p,email:x}))},d=f=>{const p=f.target.name,x=f.target.value;l(g=>({...g,[p]:x}))};return r?u.jsx(Hn,{}):n?u.jsx(Bn,{}):u.jsxs(xb,{children:[u.jsx("h3",{children:"Settings"}),u.jsx("form",{className:"form",onSubmit:c,children:u.jsxs("div",{className:"form-center",children:[a.isResetPassword?u.jsxs(u.Fragment,{children:[u.jsx("h3",{children:"Reset Password"}),u.jsx(Sr,{type:"password",name:"oldPassword",labelText:"Old Password",value:a.oldPassword,handleChange:d}),u.jsx(Sr,{type:"password",name:"newPassword",labelText:"New Password",value:a.newPassword,handleChange:d})]}):u.jsxs(u.Fragment,{children:[u.jsx("h3",{children:"Profile"}),u.jsx(Sr,{type:"text",name:"name",value:a.name,handleChange:d}),u.jsx(Sr,{type:"email",name:"email",value:a.email,handleChange:d})]}),u.jsx("button",{className:"btn",style:{backgroundColor:"var(--clr-red-dark)"},type:"button",onClick:()=>l(f=>({...f,isResetPassword:!a.isResetPassword})),children:"reset password"}),u.jsx("button",{className:"btn btn-block",type:"submit",disabled:e,children:e?"Please Wait...":"save changes"})]})}),u.jsx("h3",{children:"View All Orders"}),u.jsx(Jj,{}),u.jsx(Sv,{})]})},xb=U.section`
  border-radius: var(--borderRadius);
  width: 100%;
  background: var(--white);
